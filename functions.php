...
// 5. Admin Styles & Dark Mode
add_action('admin_head', function () {
    echo '<meta name="color-scheme" content="light dark" />';
});

// 6. Import Bootstrap for blog styles/functs
...
// 7. Import styles for dashboard and fonts
...
// 8. Convert single Markdown newlines to hard breaks before parsing
