		...
		<div class="notice notice-warning is-dismissible">
			<p>
				...
				<ul>
					...
					<li>If you find that you need to push news items into next week, first open the acrhive view in a new tab and use the <b>search function</b> to see if the Show Post has already been made and add to that instead.</li>
